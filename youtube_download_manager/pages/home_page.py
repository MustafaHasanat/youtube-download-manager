...
class HomePage:
    ...
    def __init__(self, master, palette, width, height):
        ...
        self.app_info = Label(self.page, text=app_info_text, wraplength=int(width), justify="center", 
                              font=("Berlin Sans FB", 20), bg=palette["green"], fg=palette["light-green"])
        self.app_info.pack(side="top", pady=10, padx=10)
        self.guide = Label(self.page, text=guide_text, wraplength=int(width), justify="center",
                              font=("Berlin Sans FB", 20), bg=palette["green"], fg=palette["light-green"])
